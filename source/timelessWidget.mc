...
class timelessWidget extends Ui.Drawable {
    ...
    function drawSector0(dc) {
        ...
        dc.setColor(fgColor, Gfx.COLOR_TRANSPARENT);        
        dc.drawText(dc.getWidth()/2, dc.getHeight()/2 - 13*radius/32 + fontHeight / 2, Gfx.FONT_TINY, text, Gfx.TEXT_JUSTIFY_CENTER);     
    }
    ...
    function drawSector1(dc) {
        ...
        dc.setColor(fgColor, Gfx.COLOR_TRANSPARENT);
        dc.drawText(dc.getWidth()/2 - 11*radius/32, dc.getHeight()/2 - fontHeight / 2, Gfx.FONT_TINY, text, Gfx.TEXT_JUSTIFY_CENTER);     
    }
    ...
    function drawSector2(dc) {
        ...
        dc.setColor(fgColor, Gfx.COLOR_TRANSPARENT);
        dc.drawText(dc.getWidth()/2, dc.getHeight()/2 + 13*radius/32 - 3 * fontHeight / 2, Gfx.FONT_TINY, text, Gfx.TEXT_JUSTIFY_CENTER);     
    }
